...
<html lang="en">
    <head>
        ...
        <script async="" defer="" data-domain="rauno.me" src="/js/script.js"></script>
        <script>
            !function() {
                try {
    ...
    <body>
        ...
        <script id="__NEXT_DATA__" type="application/json">
            {"props":{"pageProps":{"statusCode":404}},"page":"/_error","query":{},"buildId":"tx3WNAw9_r1G1HCTDiG6h","nextExport":true,"isFallback":false,"gip":true,"scriptLoader":[]}
        </script>
    </body>
</html>
